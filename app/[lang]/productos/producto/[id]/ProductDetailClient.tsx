...
export function ProductDetailClient({ product, lang, error }: ProductDetailClientProps) {
                            ...
                            <div className="flex flex-col sm:flex-row gap-4">
                                ...
                                <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} className="flex-1">
                                    <Button
                                        ...
                                        onClick={() => {
                                            window.open(
                                                `https://wa.me/5215512345678?text=Hola, me interesa el producto ${product.name}`,
                                                "_blank",
                                            )
                                        }}
                                    >
